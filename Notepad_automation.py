...
definition = (
    ...
    "It can be used to automate applications through the same interfaces that are available to human users."
)
...
time.sleep(2)  # Wait for the screenshot viewer to open

# 6. Closing Notepad
desktop.close_application(notepad_process)
